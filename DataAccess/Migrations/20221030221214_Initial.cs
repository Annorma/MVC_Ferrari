        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoKMh = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 2, "The F8 Spider’s greatest achievement is the fact that it unleashes its power instantaneously with zero turbo lag, whilst retaining this V8’s unique and very special soundtrack.", "https://i.wpimg.pl/1920x0/m.autokult.pl/ferrari-f8-spider-4-be8031ebb9c0.jpg", "F8 Spider", 274280m, 2.8999999999999999 });

            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "Id", "ColorId", "Description", "ImagePath", "Model", "Price", "StoKMh" },
                values: new object[] { 2, 10, "The Ferrari Portofino M’s engine belongs to the V8 turbo family voted “International Engine of the Year” on four consecutive occasions. The power unit can punch out 620 cv, 20 more than the Ferrari Portofino, thanks to new cam profiles and the introduction of a new speed sensor on the turbocharger assembly to measure the turbine revolutions. A new Gasoline Particulate Filter allows the car to comply with the strictest European anti-pollution standards (Euro-6D) without compromising driving pleasure.", "https://ocdn.eu/images/pulscms/MTE7MDA_/a4ee38a1d3741562afa4faa20746f704.jpg", "Ferrari Portofino M", 230950m, 3.4500000000000002 });

            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "Id", "ColorId", "Description", "ImagePath", "Model", "Price", "StoKMh" },
                values: new object[] { 3, 5, "To maintain the traditional, incredibly high standard of engine sound whilst simultaneously introducing a GPF (Gasoline Particulate Filter), a new exhaust tailpipe was added. This design solution reinstates medium-high frequency sound. In order to deliver excellent acoustics, performance and aesthetics, the exhaust tailpipes are visible to underscore their function and the car’s track-inspired character. The addition of a second pair of resonators enhances the engine’s more noble combustion order harmonics, creating the perfect melding of the sound from the exhaust and from the intake system.", "https://profiauto.pl/blog/wp-content/uploads/2021/05/Ferrari-812-Competizione.jpg", "FERRARI 812 COMPETIZIONE", 601570m, 2.8999999999999999 });
